...
"}"));
        ...
        stackedView->setGeometry(QRect(20, 320, 441, 241));
...
"}"));
        ...
        lyricsDisplay = new ClickableTextEdit(page_Lyrics);
        ...
        lyricsDisplay->setProperty("readOnly", QVariant(true));
        ...
        listWidget_SearchResult->setGeometry(QRect(10, 10, 421, 231));
        QPalette palette2;
        ...
        listWidget_Queue = new QListWidget(centralwidget);
        listWidget_Queue->setObjectName("listWidget_Queue");
        listWidget_Queue->setGeometry(QRect(470, 320, 181, 241));
        listWidget_Queue->setStyleSheet(QString::fromUtf8("QListWidget {\n"
"    color: white;\n"
